        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    ...
                    <form style="display: inline-block;margin-left:20px;" action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><i data-feather="log-out"></i>
                            Logout</button>
                    </form>
                @else
                    <a href="{{ route('login') }}"
