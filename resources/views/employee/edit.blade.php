                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.update',['admin'=>$employee->id]) }}" method="POST" class="form">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" @class(['form-control', 'is-invalid' => $errors->has('name')]) placeholder="name"
                                                        name="name" id="first-name-icon" value="{{ old('name',$employee->name) }}">
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="email" @class(['form-control', 'is-invalid' => $errors->has('email')]) placeholder="email"
                                                        name="email" id="first-name-icon" value="{{ old('email',$employee->email) }}">
                                                    <div class="form-control-icon">
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="number" min="18" max="65"
                                                        ...
                                                        id="first-name-icon" value="{{ old('age',$employee->age) }}">
                                                    <div class="form-control-icon">
                                                        <i class="fa fa-user"></i>
                                                    </div>
                                                    @error('age')
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" @class(['form-control', 'is-invalid' => $errors->has('mobile')]) placeholder="contact"
                                                        name="mobile" id="first-name-icon" value="{{ old('mobile',$employee->mobile) }}">
                                                    <div class="form-control-icon">
